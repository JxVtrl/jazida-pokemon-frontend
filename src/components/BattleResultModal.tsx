...
export default function BattleResultModal({ isOpen, onClose, pokemon, result }: BattleResultModalProps) {
  ...
  const getResultTitle = () => {
    switch (result) {
      ...
      case 'death': return '💀 Pokémon Derrotado';
      default: return 'Batalha Finalizada';
    }
  };
  ...
  const getResultColor = () => {
    switch (result) {
      ...
      case 'defeat': return 'text-yellow-600';
  ...
  const getResultMessage = () => {
    switch (result) {
      case 'victory': return 'Seu pokémon ganhou experiência!';
      case 'defeat': return 'Seu pokémon perdeu experiência...';
      case 'death': return 'Seu pokémon foi derrotado e não sobreviveu...';
      default: return '';
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full mx-4">
        ...
        <div className="text-center mb-6">
          ...
          <h3 className="text-xl font-bold text-gray-800 mb-2">{pokemon.tipo}</h3>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="relative">
              ...
              {showAnimation && getLevelChange() && (
                <span className={`absolute -top-2 -right-8 text-sm font-bold animate-bounce ${
                  getLevelChange()?.startsWith('+') ? 'text-green-600' : 'text-red-600'
                }`}>
                  {getLevelChange()}
                </span>
              )}
        ...
        {result === 'death' && showAnimation && (
          <div className="text-center mb-6">
            ...
            <p className="text-red-600 font-semibold">Pokémon não sobreviveu à batalha</p>
          </div>
        )}
